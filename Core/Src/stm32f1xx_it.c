...
{
  HAL_GPIO_EXTI_IRQHandler(KEY3_UNUSED_GPIO_PIN);
}

void EXTI9_5_IRQHandler(void)
{
  HAL_GPIO_EXTI_IRQHandler(KEY4_DOWN_CLEAR_GPIO_PIN);
  HAL_GPIO_EXTI_IRQHandler(KEY5_SETTING_GPIO_PIN);
  HAL_GPIO_EXTI_IRQHandler(KEY6_UP_GPIO_PIN);
}
